/*
    IMPORTANT: this plugin has been modified by Ben Snart http://www.cupidmedia.com
	* added support to call prev next slides
	* added option to pass in function that gets executed at end of setCurrentPage
...
(function($) {
    ...
    // Add a reverse reference to the DOM object
      ...
      // Top and tail the list with 'visible' number of items, top has the last section, and tail has the first
		...
		base.setCurrentPage = function(page, move) {
			...
			// BS - execute custom function if defined
			if (typeof(base.options.executeFunctionAfterSlide) == "function") {
				base.options.executeFunctionAfterSlide(base.currentPage);
			}
    ...
    $.anythingSlider.defaults = {
      ...
      pauseOnHover: true,             // If true, and autoPlay is enabled, the show will pause on hover
		...
		executeFunctionAfterSlide: null	// BS - pass in custom function to be executed afterat end of setCurrentPage. I use this to highlight custom slider navigation.
    };
	...
	$.fn.anythingSlider = function(options) {
		...
		// BS - added option to access prev / next functions when building custom navigation
