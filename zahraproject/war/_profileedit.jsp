...
<% // Get Entity
 ...
 if(session.getAttribute("uid") != null) { uid4 = session.getAttribute("uid").toString(); }

int ui = Integer.parseInt(uid4);
try {
Key ky = KeyFactory.createKey("USERS", ui);
Entity e1 = ds3.get(ky);
...
try { 
	...
	q1.addFilter("userid", Query.FilterOperator.EQUAL, uid4);
	PreparedQuery pq = ds3.prepare(q1);
...
<input type="text" name="userid" id="userid" size="20" value="<%=uid4 %>" ></li>
